...
tools: ['codebase', 'editFiles', 'runTests', 'search', 'runCommands', 'problems', 'testFailure', 'usages', 'githubRepo', 'fetch', 'new', 'runTasks', 'searchResults', 'terminalLastCommand', 'changes', 'vscodeAPI', 'extensions', 'findTestFiles']
---
