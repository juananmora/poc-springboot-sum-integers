...
Este proyecto es una demostración de **desarrollo dirigido por pruebas (TDD)** usando Spring Boot 3.3.5 y Java 17. Incluye:

- ✅ **327+ pruebas automatizadas** (unitarias, integración, end-to-end)
- 📊 **95%+ cobertura de código** con Jacoco
- 🔐 **Sistema de autenticación** con JWT y Spring Security
- 🧮 **Operaciones matemáticas** (aritméticas, estadísticas, algoritmos)
- 🗺️ **Algoritmo de Dijkstra** para caminos más cortos en grafos
- 🏗️ **Arquitectura en capas** (Controller → Service → DTO)

## 🏗️ Arquitectura

El proyecto sigue una **arquitectura en capas estricta** para separar responsabilidades:
...
1. **Separación de responsabilidades:**
   - **Controllers:** Solo manejan HTTP (request/response, códigos de estado)
   - **Services:** Contienen toda la lógica de negocio y validaciones
   - **DTOs:** Objetos inmutables para transferencia de datos

2. **Inyección de dependencias:**
   - Constructor injection (no `@Autowired` en campos)
   - Facilita testing con Mockito
...
[Service] - Ejecuta lógica de negocio
    ↓
[DTO] - Encapsula respuesta
    ↓
[Controller] - Convierte a ResponseEntity
    ↓
...
- Username: mínimo 3 caracteres, solo alfanuméricos y guiones
